...
React와 Tailwind CSS를 사용하여 단일 HTML 파일로 구현되었으며, Google Gemini API를 활용한 AI 기능이 포함되어 있습니다.
...
- **기술 연구 트리**: 시대를 앞서가는 다양한 기술 연구 및 잠금 해제
...
1. `CivilizationFinal.html` (또는 `index.html`) 파일을 다운로드합니다.
2. 파일을 크롬(Chrome), 엣지(Edge), 사파리(Safari) 등 최신 웹 브라우저로 엽니다.
3. 게임이 즉시 시작됩니다!

## 🛠️ 기술 스택

- **Core**: HTML5, JavaScript (ES6+)
- **Library**: React 18 (CDN), ReactDOM 18 (CDN)
- **Compiler**: Babel (CDN, for JSX)
...
```
/
├── index.html      # 게임의 모든 로직과 스타일이 포함된 메인 파일
└── README.md       # 프로젝트 설명서
```
